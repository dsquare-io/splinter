...
function RootComponent() {
    ...
    return (
        <div className="">
            <Link className="px-6 pt-6 pb-4 flex items-center gap-x-1.5 xl:hidden text-sm text-sky-700 font-medium mb-1" to="/friends">
                ...
                <div>
                    ...
                    <div className="mx-auto  px-4 sm:px-6 lg:px-8">
                        <div className="-mt-12 sm:flex sm:items-end space-x-3">
                            <div className="flex">
                                <Avatar className="bg-slate-200 size-24 text-3xl" fallback="GP"/>
                            </div>
                            <div
