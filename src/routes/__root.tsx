...
function RootComponent() {
  return (
    <>
      <div className="fixed inset-y-0 z-30 w-60 p-4 flex flex-col overflow-scroll space-y-4 border-e border-slate-200">
        <Link to="/" className="flex items-center gap-x-3 py-1 px-2.5">
        ...
        <div className="grow">
          <Link to="/groups"
                className="flex items-center rounded-md px-3 py-2.5 gap-x-3.5 text-slate-600 hover:bg-slate-100 hover:text-slate-800 transition-colors">
        ...
        <div>
          ...
          <Link to="/groups"
                className="flex items-center rounded-md px-1.5 py-3 gap-x-2 hover:bg-slate-100 transition-colors">
