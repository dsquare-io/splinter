      ...
      <article>
          ...
          <div className="sm:col-span-3">
            ...
            <div className="mt-2">
              <input
                ...
                className="block w-full rounded-md bg-white/60 px-4 py-1.5 ring-1 ring-gray-300 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-600 sm:text-sm sm:leading-6"
              />
            </div>
          </div>
        ...
        <div className="mt-8 border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 space-y-10">
            ...
            <fieldset>
              <legend className="text-sm font-medium leading-6 text-gray-800">Push Notifications</legend>
              <p className="mt-1 text-sm leading-6 text-gray-500">
