...
export function ImagePreview({ src, alt }: Props) {
  ...
  useEffect(() => {
    ...
    if (anchor) {
      el.scrollLeft = anchor.ratioX * el.scrollWidth - el.clientWidth / 2;
      el.scrollTop = anchor.ratioY * el.scrollHeight - el.clientHeight / 2;
  ...
  const captureScrollAnchor = () => {
    ...
    scrollAnchorRef.current = {
      ratioX: (el.scrollLeft + el.clientWidth / 2) / el.scrollWidth,
      ratioY: (el.scrollTop + el.clientHeight / 2) / el.scrollHeight,
    };
  };
