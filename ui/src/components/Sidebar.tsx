...
import {ArrowLeftStartOnRectangleIcon, PlusIcon, UserIcon, UsersIcon,} from '@heroicons/react/24/outline';
...
import {AddExpense} from "@components/AddExpense/AddExpense.tsx";
