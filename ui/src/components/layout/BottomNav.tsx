...
export function BottomNav() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-[calc(0px+env(safe-area-inset-bottom))] isolate z-20 flex h-16 w-full content-stretch justify-center border-t border-neutral-200 bg-white md:hidden">
      <Link
        to="/groups"
